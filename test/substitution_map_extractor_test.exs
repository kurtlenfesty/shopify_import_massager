defmodule SubstitutionMapExtractorTest do
  use ExUnit.Case
  ...
  describe "extract_order_number/1" do
    test "extracts order number when it exists" do
      assert SubstitutionMapExtractor.extract_order_number("#12345") == 12345
      assert SubstitutionMapExtractor.extract_order_number("#99123") == 99123
      assert SubstitutionMapExtractor.extract_order_number("#1") == 1
    end

    test "extracts nil when order number doesn't match" do
      assert SubstitutionMapExtractor.extract_order_number("#191192_TOGETHER") == nil
      assert SubstitutionMapExtractor.extract_order_number("#191_MULT-LINE-ONE_189") == nil
      assert SubstitutionMapExtractor.extract_order_number("THREE#191203") == nil
      assert SubstitutionMapExtractor.extract_order_number("just a string") == nil
      assert SubstitutionMapExtractor.extract_order_number("1234") == nil
    end
  end
  ...
  describe "convert_to_order_number_name_map/1" do
    test "converts properly to number-name map" do
      ...
      assert SubstitutionMapExtractor.convert_to_order_number_name_map(source) == [
  ...
  describe "convert_mapped/1" do
    test "extracts a sequence correctly" do
      ...
      assert SubstitutionMapExtractor.convert_mapped(source) == [
               %{
                 is_valid: true,
                 order_name: "#191207",
