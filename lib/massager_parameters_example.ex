defmodule MassagerParametersExample do
  # TODO:
  # 1. Make a copy of this file and rename it to: `massager_parameters.ex`
  # 2. Rename the module name to `MassagerParameters`
  # 3. Change the parameters to reflect the files you are trying to modify
  #
  # The copied `massager_parameters.ex` won't be added to git.
